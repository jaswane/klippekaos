...
button('Katt: neste varsel',()=>{levelSelect.value='3';fixture();game.x=100;game.y=500;game.time=Klippe.eventTuning.catFirst-1.7;game.started=true;frozen=false;});
...
function debug(){
 ...
 document.getElementById('artNests').textContent='Bol truffet: '+touched+'/'+game.waspNests.length+' · hendelser: '+used+'/4 · igjen: '+(game.waspNests.length-used);
